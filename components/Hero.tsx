...
const Hero: React.FC<HeroProps> = ({ data }) => {
  ...
  // Use a static, persistent URL for the profile image from the user's GitHub profile.
  // This ensures the image is consistent for all visitors.
  const profileImageUrl = 'https://avatars.githubusercontent.com/u/87063467?v=4';
